	...
	<input type="submit" name="registerForm" value="Register">     	
     ...
     <div class="search">
      <form action="searchPhoto.php" method="GET" id="search">
      	Search Photos:<br><input placeholder="nature" type="text" name="search">
      </form>
      <button type="submit" form="search" value="Submit">Search</button>
</div>
      
      <h3 class="logged"><?php if(!empty($_SESSION['username'])){?>Current logged in user: <?=$_SESSION['username']?><?php }?></h3>
